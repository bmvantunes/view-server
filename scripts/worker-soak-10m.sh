...
export VS_WORKER_SOAK_MUTATION_BATCH_SIZE
...
printf 'rows=%s raw=%s grouped=%s mutations=%s mutationBatchSize=%s activePlanAutoBuildMaxRows=%s timeoutMs=%s maxOldSpaceMb=%s\n' \
  "$VS_WORKER_SOAK_ROWS" \
